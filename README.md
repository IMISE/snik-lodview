...
This is a fork of [LodView](https://github.com/dvcama/LodView) for the [SNIK project](https://www.snik.eu).

## Develop
LodView is a Java web application based using Maven using the [SNIK SPARQL endpoint](https://www.snik.eu/sparql).

## Run Locally

1. `mvn jetty:run`
2. open http://localhost:8080/lodview/
